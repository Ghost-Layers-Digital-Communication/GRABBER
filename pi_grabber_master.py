...
PORT = 5150
REMOTE_FILE = "/home/xxxxx/Desktop/xxxxxxxxx.xxx" # replace xxx with user name and file name
LOCAL_DESKTOP = os.path.join(os.path.expanduser("~"), "Desktop")
LOCAL_FILE = os.path.join(LOCAL_DESKTOP, "xxxxxxx.xxx") #replace xxx with file name
# ----------------------------
